...
let UserServiceImpl = class UserServiceImpl {
    ...
    updateUser(userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const isUpdated = yield this.userRepository.updateUser(userId, data);
            return isUpdated;
        });
    }
    deleteUser(userId) {
    ...
    updatePassword(userId, password, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            const isUpdated = yield this.userRepository.updatePassword(userId, password, newPassword);
            return isUpdated;
        });
    }
    forgotPassword(email) {
        return __awaiter(this, void 0, void 0, function* () {
            const forgotPassword = yield this.userRepository.forgotPassword(email);
            return forgotPassword;
        });
    }
    resetPassword(token, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            const isUpdated = yield this.userRepository.resetPassword(token, newPassword);
            return isUpdated;
        });
    }
};
